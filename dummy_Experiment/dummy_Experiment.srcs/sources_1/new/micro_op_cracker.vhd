...
entity micro_op_cracker is
  Port (
    ...
    uop1_ra  : out std_logic_vector(2 downto 0);
    uop1_rb  : out std_logic_vector(2 downto 0);
    ...
    uop2_ra : out std_logic_vector(2 downto 0);
    uop2_rb : out std_logic_vector(2 downto 0);
                ...
                for i in 0 to 7 loop
                    if temp_mask(i) = '1' then
                        ...
                        if found_count = 0 then
                            ...
                            uop1_ra <= stored_base;
                            uop1_rb <= std_logic_vector(to_unsigned(reg_idx, 3));
                            ...
                            uop2_ra <= stored_base;
                            uop2_rb <= std_logic_vector(to_unsigned(reg_idx, 3));
