...
architecture Behavioral of ID_stage is
    ...
    signal we_flag1_s : std_logic;
    signal we_flag2_s : std_logic;
...
begin
    ...
    decoder_inst1 : entity work.instruction_decoder 
        port map(
            ...
            we_gpr      => we_gpr1,
            we_flag     => we_flag1_s,  -- THE RECONNECTED WIRE!
    ...
    decoder_inst2 : entity work.instruction_decoder 
        port map(
            ...
            we_gpr      => we_gpr2,
            we_flag     => we_flag2_s,  -- THE RECONNECTED WIRE!
    ...
    we_flag1 <= we_flag1_s and dec_valid1;
    we_flag2 <= we_flag2_s and dec_valid2;
