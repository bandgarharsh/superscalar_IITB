...
entity ROB is
    Port (
        ...
        -- ADD THESE TWO NEW PORTS FOR THE FIX
    ...
    begin
        if rising_edge(clk) then
            ...
            if rst = '1' then
                ...
                -- ADD THIS BLOCK TO HANDLE THE MEMORY VIOLATION FLUSH
                if lsu_violation = '1' then
                    ...
                    -- Tell the IF stage to re-fetch the Load instruction so it executes correctly this time!
